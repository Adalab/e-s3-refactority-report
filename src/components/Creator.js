...
class Creator extends Component {
    ...
    const {card, cardTitles, arraySkills, actionName, valueName, actionJob, valueJob, actionEmail, actionTel, actionLinkedin, actionGit, handleUrl, imageDefault, actionTypo, actionColor, actionFetch, actionFillS, handleReset} = this.props;
        ...
        return(
            <React.Fragment>
                <Header />
                  <MainCreator actionName={actionName} valueName={valueName} actionJob={actionJob} valueJob={valueJob} imageDefault={imageDefault} handleUrl={handleUrl} arraySkills={arraySkills} card={card} cardTitles={cardTitles} actionEmail={actionEmail} actionTel={actionTel} actionLinkedin={actionLinkedin} actionGit={actionGit} actionTypo={actionTypo} actionColor={actionColor} actionFetch={actionFetch} actionFillS={actionFillS} handleReset={handleReset}/>
                <Footer />
            </React.Fragment>
        );
    }
